  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <label htmlFor="name" className="label text-base-content">
            Name
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="email" className="label text-base-content">
            Email
          </label>
          <input
            type="email"
        ...
        <div>
          <label htmlFor="message" className="label text-base-content">
            Message
          </label>
          <textarea
            id="message"
